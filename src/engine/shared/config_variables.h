...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 32, 1, ZOMBIE_START, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
MACRO_CONFIG_INT(SvMaxClientsPerIP, sv_max_clients_per_ip, 4, 1, ZOMBIE_START, CFGFLAG_SERVER, "Maximum number of clients with the same IP that can connect to the server")
...
MACRO_CONFIG_STR(Jiuyuan, jy_password, 32, "", CFGFLAG_SERVER, "hi")
