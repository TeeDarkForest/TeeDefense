			...
			{		
				...
				if(Data->m_SqlData->results->next())
				{
					...
					if(Data->m_SqlData->results->next())
					{
						...
						if(Data->m_SqlData->results->next())
						{
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("Log")] = Data->m_SqlData->results->getInt("Log");
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("Coal")] = Data->m_SqlData->results->getInt("Coal");
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("Copper")] = Data->m_SqlData->results->getInt("Copper");
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("Iron")] = Data->m_SqlData->results->getInt("Iron");
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("Gold")] = Data->m_SqlData->results->getInt("Gold");
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("Diamond")] = Data->m_SqlData->results->getInt("Diamond");
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("Enegry")] = Data->m_SqlData->results->getInt("Enegry");
							GameServer()->m_apPlayers[Data->m_ClientID]->m_Knapsack.m_Resource[GameServer()->GetResourceId("ZombieHeart")] = Data->m_SqlData->results->getInt("ZombieHeart");
	...
	if(Data->m_SqlData->connect())
	{
		try
		{
			...
			if(Data->m_SqlData->results->next())
			{
				...
				"WHERE UserID=%d", \
				Data->m_SqlData->prefix,
				p->m_Knapsack.m_Resource[GameServer()->GetResourceId("Log")],p->m_Knapsack.m_Resource[GameServer()->GetResourceId("Coal")],p->m_Knapsack.m_Resource[GameServer()->GetResourceId("Copper")], \
				p->m_Knapsack.m_Resource[GameServer()->GetResourceId("Iron")],p->m_Knapsack.m_Resource[GameServer()->GetResourceId("Gold")],p->m_Knapsack.m_Resource[GameServer()->GetResourceId("Diamond")], \
				p->m_Knapsack.m_Resource[GameServer()->GetResourceId("Enegry")],p->m_Knapsack.m_Resource[GameServer()->GetResourceId("ZombieHeart")],p->m_Knapsack.m_Sword, \
